 ...
 */
var BingWebmaster = /*#__PURE__*/function (_Component) {
  _inherits(BingWebmaster, _Component);
  var _super = _createSuper(BingWebmaster);
  function BingWebmaster() {
    _classCallCheck(this, BingWebmaster);
    return _super.apply(this, arguments);
  }
  _createClass(BingWebmaster, [{
    key: "render",
    value: function render() {
      var trackingId = this.props.trackingId;
      return (0, _inferno.createVNode)(1, "meta", null, null, 1, {
        "name": "msvalidate.01",
        "content": trackingId
      });
    }
 ...
 *     plugin={{ tracking_id: '*******' }} />
 */
BingWebmaster.Cacheable = cacheComponent(BingWebmaster, 'plugin.bingwebmaster', function (props) {
  var head = props.head,
    plugin = props.plugin;
