 ...
 */
var ShareThis = /*#__PURE__*/function (_Component) {
  _inherits(ShareThis, _Component);
  var _super = _createSuper(ShareThis);
  function ShareThis() {
  ...
  _createClass(ShareThis, [{
    ...
    value: function render() {
      ...
      if (!installUrl) {
        return (0, _inferno.createVNode)(1, "div", "notification is-danger", [(0, _inferno.createTextVNode)("You need to set "), (0, _inferno.createVNode)(1, "code", null, "install_url", 16), (0, _inferno.createTextVNode)(" to use ShareThis. Please set it in"), (0, _inferno.createTextVNode)(' '), (0, _inferno.createVNode)(1, "code", null, "_config.yml", 16), (0, _inferno.createTextVNode)(".")], 0);
      }
 ...
 */
ShareThis.Cacheable = cacheComponent(ShareThis, 'share.sharethis', function (props) {
