  ...
  for (var i = 0, len = vNodeTree.length; i < len; ++i) {
    ...
    if (!isInvalid(children)) {
      ...
      if (childFlags & 12 /* ChildFlags.MultipleChildren */) {
        val = DEV_ValidateKeys(children, (childFlags & 8 /* ChildFlags.HasKeyedChildren */) !== 0);
...
function patch(lastVNode, nextVNode, parentDOM, context, isSVG, nextNode, lifecycle, animations) {
  ...
  {
    if (isFunction(options.componentComparator) && lastVNode.flags & nextFlags & 4 /* VNodeFlags.ComponentClass */) {
...

{
  ...
  var testingEnv = typeof process === 'object' && process.env && process.env.JEST_WORKER_ID !== undefined;
  ...
  if (!testingEnv && (testFunc.name || testFunc.toString()).indexOf('testFn') === -1) {
...
exports.AnimationQueues = AnimationQueues;
...
exports._RFC = renderFunctionalComponent;
